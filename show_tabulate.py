...
print(tabulate(data1, headers=['项目', '内容'], tablefmt='grid'))
print()
...
print(tabulate(data2, headers=['序号', '市', '县/区', '点位名称'], tablefmt='grid'))
print()
...
print(tabulate(data3, headers=['晚次', '日期', '城市', '酒店名称', '品牌', '地址', '电话', '单价/晚', '2间房总价'], tablefmt='grid'))
print()
